...
ngd_api_key = #<insert API KEY here>
...
place_api_key = #<insert API KEY here>
url_places = URI("https://api.ordnancesurvey.co.uk/places/v1/addresses/bbox?format=JSON&maxresults=null&dataset=DPA%2C%20LPI&lr=EN%2C%20CY&fq=classification_code%3A%5Bcode%5D%2C%20LOGICAL_STATUS_CODE%3A%5Bcode%5D&output_srs=BNG%2C%20EPSG%3A27700%2C%20WGS84%2C%20EPSG%3A4326%2C%20EPSG%3A3857%2C%20EPSG%3A4258&srs=BNG%2C%20EPSG%3A27700%2C%20WGS84%2C%20EPSG%3A4326%2C%20EPSG%3A3857%2C%20EPSG%3A4258&key=" + place_api_key)
